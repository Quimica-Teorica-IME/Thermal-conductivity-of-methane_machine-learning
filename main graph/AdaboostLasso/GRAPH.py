...
def plot_comparison(phase_name, y_exp, y_nist, y_model, save_path=None, name=None):
    ...
    #plt.scatter(y_exp, y_model, color='red', label='AdaboostLasso', marker='o', facecolors='none', edgecolors='red', s=150, linewidth=2)
    ...
    plt.scatter(y_exp, y_model, color='red', label='AdaboostLasso',  marker='+', s=150, linewidth=2)
