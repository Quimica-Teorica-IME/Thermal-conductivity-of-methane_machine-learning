...
def plot_comparison(phase_name, y_exp, y_nist, y_model, save_path=None, name=None):
    ...
    plt.scatter(y_exp, y_model, color='red', label='NN', marker = '+', s=40, linewidth=1)
...
# ***** DECISION TREE *****
DT_file = check_and_get_filename(current_directory, "DecisionTree_Physical-State-Determination_NN", "log")
...
NN_directory = os.path.join(property_directory, "NN-cv10")
os.makedirs(NN_directory, exist_ok=True)
NN_file = check_and_get_filename(NN_directory, "NN-cv10", "log")
...
save_to_file_and_print(f"\nBest Hyperparameters for liquid state for NN: {grid_search_liquid.best_params_}.\n", NN_file)

model_liquid = grid_search_liquid.best_estimator_
model_liquid.fit(X_liquid_train, y_liquid_train)

joblib.dump(model_liquid, os.path.join(NN_directory, 'Model_NN_liquid.pkl'))

#model_liquid_path = os.path.join(NN_directory, 'Model_NN_liquid.pkl')
...
# >>> Train <<<
save_to_file_and_print("\n > Train data <", NN_file)
calculate_metrics('liquid', y_liquid_train, y_pred_train_liquid, file=NN_file)

# >>> Test <<<
save_to_file_and_print("\n > Test data <", NN_file)
calculate_metrics('liquid', y_liquid_test,  y_pred_test_liquid, file=NN_file)

plot_overfitting_evaluation(y_liquid_test, y_pred_test_liquid, save_path=NN_directory, name="NN-overfitting_evaluation-liquid", phase_name="liquid")
...
save_to_file_and_print(f"\nBest Hyperparameters for vapor state for NN: {grid_search_vapor.best_params_}.\n", NN_file)

model_vapor = grid_search_vapor.best_estimator_
model_vapor.fit(X_vapor_train, y_vapor_train)

joblib.dump(model_vapor, os.path.join(NN_directory, 'Model_NN_vapor.pkl'))

#model_vapor_path = os.path.join(NN_directory, 'Model_NN_vapor.pkl')
...
# >>> Train <<<
save_to_file_and_print("\n > Train data <", NN_file)
calculate_metrics('vapor', y_vapor_train, y_pred_train_vapor, file=NN_file)

# >>> Test <<<
save_to_file_and_print("\n > Test data <", NN_file)
calculate_metrics('vapor', y_vapor_test,  y_pred_test_vapor, file=NN_file)

plot_overfitting_evaluation(y_vapor_test, y_pred_test_vapor, save_path=NN_directory, name="NN-overfitting_evaluation-vapor", phase_name="vapor")
...
save_to_file_and_print(f"\nBest Hyperparameters for supercritical state for NN: {grid_search_supercritical.best_params_}.\n", NN_file)
...
joblib.dump(model_supercritical, os.path.join(NN_directory, 'Model_NN_supercritical.pkl'))

#model_supercritical_path = os.path.join(NN_directory, 'Model_NN_supercritical.pkl')
...
# >>> Train <<<
save_to_file_and_print("\n > Train data <", NN_file)
calculate_metrics('supercritical', y_supercritical_train, y_pred_train_supercritical, file=NN_file)

# >>> Test <<<
save_to_file_and_print("\n > Test data <", NN_file)
calculate_metrics('supercritical', y_supercritical_test,  y_pred_test_supercritical, file=NN_file)

plot_overfitting_evaluation(y_supercritical_test, y_pred_test_supercritical, save_path=NN_directory, name="NN-overfitting_evaluation-supercritical", phase_name="supercritical")
...
save_to_file_and_print(f"*** Cross-Validation Metrics ***", NN_file)
...
calculate_metrics("liquid (NIST)", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, file=NN_file)
calculate_metrics("liquid (Model)", y_liquid_Exp_array, y_pred_liquid_cv_array, file=NN_file)

#vapor
save_to_file_and_print(">>> Vapor <<<\n", NN_file)
calculate_metrics("vapor (NIST)", y_vapor_Exp_array, y_vapor_NIST_Expbased_array, file=NN_file)
calculate_metrics("vapor (Model)", y_vapor_Exp_array, y_pred_vapor_cv_array, file=NN_file)

#supercritical
save_to_file_and_print(">>> Supercritical <<<\n", NN_file)
calculate_metrics("supercritical (NIST)", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, file=NN_file)
calculate_metrics("supercritical (Model)", y_supercritical_Exp_array, y_pred_supercritical_cv_array, file=NN_file)

# Liquid phase
plot_comparison("liquid", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, save_path=NN_directory, name="ModelxNISTxExp-liquid")

# Vapor phase
plot_comparison("vapor",  y_vapor_Exp_array, y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, save_path=NN_directory, name="ModelxNISTxExp-vapor")

# Supercritical phase
plot_comparison("supercritical", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, save_path=NN_directory, name="ModelxNISTxExp-supercritical")
...
#liquid
save_to_file_and_print(">>> Liquid <<<\n", NN_file)
calculate_metrics("NIST x Model", y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, file=NN_file)

#vapor
save_to_file_and_print(">>> Vapor <<<\n", NN_file)
calculate_metrics("vapor (NIST)", y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, file=NN_file)

#supercritical
save_to_file_and_print(">>> Supercritical <<<\n", NN_file)
calculate_metrics("supercritical (NIST)", y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, file=NN_file)

# Liquid phase
plot_overfitting_evaluation(y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, save_path=NN_directory, name="ModelxNIST-liquid", phase_name='Liquid')

# Vapor phase
plot_overfitting_evaluation(y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, save_path=NN_directory, name="ModelxNIST-vapor", phase_name='Vapor')

# Supercritical phase
plot_overfitting_evaluation(y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, save_path=NN_directory, name="ModelxNIST-Supercritical", phase_name='Supercritical')
