...
GradientBoosting_directory = os.path.join(property_directory, "GradientBoosting-cv10")
os.makedirs(GradientBoosting_directory, exist_ok=True)
GradientBoosting_file = check_and_get_filename(GradientBoosting_directory, "GradientBoosting-cv10", "log")
