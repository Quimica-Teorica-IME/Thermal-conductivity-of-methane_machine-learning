...
NN_directory = os.path.join(property_directory, "NN-cvLOO")
os.makedirs(NN_directory, exist_ok=True)
NN_file = check_and_get_filename(NN_directory, "NN-cvLOO", "log")
...
if len(X_liquid_Exp) > 0:
    ...
    calculate_metrics("liquid - Exp x NIST", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, file=NN_file)
    calculate_metrics("liquid - Exp x Model", y_liquid_Exp_array, y_pred_liquid_cv_array, file=NN_file)
    calculate_metrics("liquid - NIST x Model", y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, file=NN_file)
...
if len(X_vapor_Exp) > 0:
    ...
    calculate_metrics("vapor - Exp x NIST", y_vapor_Exp_array, y_vapor_NIST_Expbased_array, file=NN_file)
    calculate_metrics("vapor - Exp x Model", y_vapor_Exp_array, y_pred_vapor_cv_array, file=NN_file)
    calculate_metrics("vapor - NIST x Model", y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, file=NN_file)
...
if len(X_supercritical_Exp) > 0:
    ...
    calculate_metrics("supercritical - Exp x NIST", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, file=NN_file)
    calculate_metrics("supercritical - Exp x Model", y_supercritical_Exp_array, y_pred_supercritical_cv_array, file=NN_file)
    calculate_metrics("supercritical - NIST x Model", y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, file=NN_file)
