...
AdaboostRidge_directory = os.path.join(property_directory, "AdaboostRidge-cv10")
os.makedirs(AdaboostRidge_directory, exist_ok=True)
AdaboostRidge_file = check_and_get_filename(AdaboostRidge_directory, "AdaboostRidge-cv10", "log")
