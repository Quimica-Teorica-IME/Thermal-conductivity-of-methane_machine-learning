...
SVR_directory = os.path.join(property_directory, "SVR")
os.makedirs(SVR_directory, exist_ok=True)
SVR_file = check_and_get_filename(SVR_directory, "SVR", "log")
...
model_liquid = SVR(**params_liquid_svr)
...
model_vapor = SVR(**params_vapor_svr)
...
model_supercritical = SVR(**params_liquid_svr)
...
calculate_metrics("liquid (NIST)", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, file=SVR_file)
calculate_metrics("liquid (Model)", y_liquid_Exp_array, y_pred_liquid_cv_array, file=SVR_file)

#vapor
save_to_file_and_print(">>> Vapor <<<\n", SVR_file)
calculate_metrics("vapor (NIST)", y_vapor_Exp_array, y_vapor_NIST_Expbased_array, file=SVR_file)
calculate_metrics("vapor (Model)", y_vapor_Exp_array, y_pred_vapor_cv_array, file=SVR_file)

#supercritical
save_to_file_and_print(">>> Supercritical <<<\n", SVR_file)
calculate_metrics("supercritical (NIST)", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, file=SVR_file)
calculate_metrics("supercritical (Model)", y_supercritical_Exp_array, y_pred_supercritical_cv_array, file=SVR_file)
...
#liquid
save_to_file_and_print(">>> Liquid <<<\n", SVR_file)
calculate_metrics("NIST x Model", y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, file=SVR_file)

#vapor
save_to_file_and_print(">>> Vapor <<<\n", SVR_file)
calculate_metrics("vapor (NIST)", y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, file=SVR_file)

#supercritical
save_to_file_and_print(">>> Supercritical <<<\n", SVR_file)
calculate_metrics("supercritical (NIST)", y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, file=SVR_file)
