...
def plot_comparison(phase_name, y_exp, y_nist, y_model, save_path=None, name=None):
    ...
    #plt.scatter(y_exp, y_model, color='red', label='ExtraTrees', marker='o', facecolors='none', edgecolors='red', s=150, linewidth=2)
    ...
    plt.scatter(y_exp, y_model, color='red', label='ExtraTrees',  marker='+', s=150, linewidth=2)
    plt.scatter(y_exp, y_exp, color='black', label='_nolegend_', marker='.', s=50, linewidth=2)

    plt.xlabel('Experimental')
    plt.ylabel('ExtraTrees & NIST')
