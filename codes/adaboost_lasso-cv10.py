...
AdaboostLasso_directory = os.path.join(property_directory, "AdaboostLasso-cv10")
os.makedirs(AdaboostLasso_directory, exist_ok=True)
AdaboostLasso_file = check_and_get_filename(AdaboostLasso_directory, "AdaboostLasso-cv10", "log")
