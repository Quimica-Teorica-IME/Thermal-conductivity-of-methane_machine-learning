# -*- coding: utf-8 -*-
"""NN_withoutgridsearch.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Jv07XP1ICXe2BGGyRA6prFdHf6M41abk
"""
...
def plot_comparison(phase_name, y_exp, y_nist, y_model, save_path=None, name=None):
    ...
    plt.scatter(y_exp, y_model, color='red', label='NN_withoutgridsearch', marker = '+', s=40, linewidth=1)

    plt.xlabel('Experimental')
    plt.ylabel('NN_withoutgridsearch & NIST')
    plt.title(phase_name)
    plt.legend()
...
# ***** DECISION TREE *****
DT_file = check_and_get_filename(current_directory, "DecisionTree_Physical-State-Determination_NN_withoutgridsearch", "log")
...
# ********************** NN_withoutgridsearch **********************

NN_withoutgridsearch_directory = os.path.join(property_directory, "NN_withoutgridsearch")
os.makedirs(NN_withoutgridsearch_directory, exist_ok=True)
NN_withoutgridsearch_file = check_and_get_filename(NN_withoutgridsearch_directory, "NN_withoutgridsearch", "log")
...
They caNN_withoutgridsearchot be accessed using indexing.
...
save_to_file_and_print(f"Number of matched data between NIST and Experimental: {len(matched_data_X)}\nNumber of missing data between NIST and Experimental: {len(missing_data_X)}", NN_withoutgridsearch_file)
...
# Grid Search for Hyperparameter Tuning for liquid state with NN_withoutgridsearch
print("Tuning hyperparameters for liquid state with NN_withoutgridsearch...")
...
joblib.dump(model_liquid, os.path.join(NN_withoutgridsearch_directory, 'Model_NN_withoutgridsearch_liquid.pkl'))

#model_liquid_path = os.path.join(NN_withoutgridsearch_directory, 'Model_NN_withoutgridsearch_liquid.pkl')
...
# >>> Train <<<
save_to_file_and_print("\n > Train data <", NN_withoutgridsearch_file)
calculate_metrics('liquid', y_liquid_train, y_pred_train_liquid, file=NN_withoutgridsearch_file)

# >>> Test <<<
save_to_file_and_print("\n > Test data <", NN_withoutgridsearch_file)
calculate_metrics('liquid', y_liquid_test,  y_pred_test_liquid, file=NN_withoutgridsearch_file)

plot_overfitting_evaluation(y_liquid_test, y_pred_test_liquid, save_path=NN_withoutgridsearch_directory, name="NN_withoutgridsearch-overfitting_evaluation-liquid", phase_name="liquid")
...
joblib.dump(model_vapor, os.path.join(NN_withoutgridsearch_directory, 'Model_NN_withoutgridsearch_vapor.pkl'))

#model_vapor_path = os.path.join(NN_withoutgridsearch_directory, 'Model_NN_withoutgridsearch_vapor.pkl')
...
# >>> Train <<<
save_to_file_and_print("\n > Train data <", NN_withoutgridsearch_file)
calculate_metrics('vapor', y_vapor_train, y_pred_train_vapor, file=NN_withoutgridsearch_file)

# >>> Test <<<
save_to_file_and_print("\n > Test data <", NN_withoutgridsearch_file)
calculate_metrics('vapor', y_vapor_test,  y_pred_test_vapor, file=NN_withoutgridsearch_file)

plot_overfitting_evaluation(y_vapor_test, y_pred_test_vapor, save_path=NN_withoutgridsearch_directory, name="NN_withoutgridsearch-overfitting_evaluation-vapor", phase_name="vapor")
...
joblib.dump(model_supercritical, os.path.join(NN_withoutgridsearch_directory, 'Model_NN_withoutgridsearch_supercritical.pkl'))

#model_supercritical_path = os.path.join(NN_withoutgridsearch_directory, 'Model_NN_withoutgridsearch_supercritical.pkl')
...
# >>> Train <<<
save_to_file_and_print("\n > Train data <", NN_withoutgridsearch_file)
calculate_metrics('supercritical', y_supercritical_train, y_pred_train_supercritical, file=NN_withoutgridsearch_file)

# >>> Test <<<
save_to_file_and_print("\n > Test data <", NN_withoutgridsearch_file)
calculate_metrics('supercritical', y_supercritical_test,  y_pred_test_supercritical, file=NN_withoutgridsearch_file)

plot_overfitting_evaluation(y_supercritical_test, y_pred_test_supercritical, save_path=NN_withoutgridsearch_directory, name="NN_withoutgridsearch-overfitting_evaluation-supercritical", phase_name="supercritical")
...
#y_pred_test_vapor_array =  np.array(model_vapor.predict(X_vapor_Exp))
...
calculate_metrics("liquid (NIST)", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, file=NN_withoutgridsearch_file)
calculate_metrics("liquid (Model)", y_liquid_Exp_array, y_pred_liquid_cv_array, file=NN_withoutgridsearch_file)

#vapor
save_to_file_and_print(">>> Vapor <<<\n", NN_withoutgridsearch_file)
calculate_metrics("vapor (NIST)", y_vapor_Exp_array, y_vapor_NIST_Expbased_array, file=NN_withoutgridsearch_file)
calculate_metrics("vapor (Model)", y_vapor_Exp_array, y_pred_vapor_cv_array, file=NN_withoutgridsearch_file)

#supercritical
save_to_file_and_print(">>> Supercritical <<<\n", NN_withoutgridsearch_file)
calculate_metrics("supercritical (NIST)", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, file=NN_withoutgridsearch_file)
calculate_metrics("supercritical (Model)", y_supercritical_Exp_array, y_pred_supercritical_cv_array, file=NN_withoutgridsearch_file)

# Liquid phase
plot_comparison("liquid", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, save_path=NN_withoutgridsearch_directory, name="ModelxNISTxExp-liquid")

# Vapor phase
plot_comparison("vapor",  y_vapor_Exp_array, y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, save_path=NN_withoutgridsearch_directory, name="ModelxNISTxExp-vapor")

# Supercritical phase
plot_comparison("supercritical", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, save_path=NN_withoutgridsearch_directory, name="ModelxNISTxExp-supercritical")
...
#liquid
save_to_file_and_print(">>> Liquid <<<\n", NN_withoutgridsearch_file)
calculate_metrics("NIST x Model", y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, file=NN_withoutgridsearch_file)

#vapor
save_to_file_and_print(">>> Vapor <<<\n", NN_withoutgridsearch_file)
calculate_metrics("vapor (NIST)", y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, file=NN_withoutgridsearch_file)

#supercritical
save_to_file_and_print(">>> Supercritical <<<\n", NN_withoutgridsearch_file)
calculate_metrics("supercritical (NIST)", y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, file=NN_withoutgridsearch_file)

# Liquid phase
plot_overfitting_evaluation(y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, save_path=NN_withoutgridsearch_directory, name="ModelxNIST-liquid", phase_name='Liquid')

# Vapor phase
plot_overfitting_evaluation(y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, save_path=NN_withoutgridsearch_directory, name="ModelxNIST-vapor", phase_name='Vapor')

# Supercritical phase
plot_overfitting_evaluation(y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, save_path=NN_withoutgridsearch_directory, name="ModelxNIST-Supercritical", phase_name='Supercritical')


# Save liquid data
liquid_data = np.column_stack((X_liquid_Exp, y_liquid_Exp_array, y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array))
np.savetxt(os.path.join(NN_directory, 'liquid_data.txt'), liquid_data, delimiter='\t', header='Temp(K)\tPressure(MPa)\tExperimental(mW/m*K)\tNIST(mW/m*K)\tModel(mW/m*K)')

# Save vapor data
vapor_data = np.column_stack((X_vapor_Exp, y_vapor_Exp_array, y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array))
np.savetxt(os.path.join(NN_directory, 'vapor_data.txt'), vapor_data, delimiter='\t', header='Temp(K)\tPressure(MPa)\tExperimental(mW/m*K)\tNIST(mW/m*K)\tModel(mW/m*K)')
...
np.savetxt(os.path.join(NN_directory, 'supercritical_data.txt'), supercritical_data, delimiter='\t', header='Temp(K)\tPressure(MPa)\tExperimental(mW/m*K)\tNIST(mW/m*K)\tModel(mW/m*K)')
