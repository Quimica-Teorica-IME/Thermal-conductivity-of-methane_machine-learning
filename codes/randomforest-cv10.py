...
RandomForest_directory = os.path.join(property_directory, "RandomForest-cv10")
os.makedirs(RandomForest_directory, exist_ok=True)
RandomForest_file = check_and_get_filename(RandomForest_directory, "RandomForest-cv10", "log")
